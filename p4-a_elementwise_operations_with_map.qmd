# Elementwise Operations with `.map()`
...
### Exercise {#sec-exercise-map-user-ids-to-names}
...
You can find two possible solutions in @sec-solution-map-user-ids-to-names.
...
It works and the code is more concise now 😊

<!-- ```{python}
[f"{minutes // 60}:{minutes - 60 * minutes // 60:02}" for minutes in durations_series]
``` -->

### Exercise {#sec-exercise-map-user-ids-to-names-with-lambda}
...
You can find a solution in @sec-solution-map-user-ids-to-names-with-lambda.
...
### Exercise {#sec-exercise-map-user-ids-to-names-with-series}

What if we had a series instead of a dictionary above with the series index and series elements corresponding to the dictionary keys and values, respectively? We can use it in place of the dictionary! Construct such a series and try it out 😉
...
### Solution to [Exercise -@sec-exercise-map-user-ids-to-names] {#sec-solution-map-user-ids-to-names}
...
### Solution to [Exercise -@sec-exercise-map-user-ids-to-names-with-lambda] {#sec-solution-map-user-ids-to-names-with-lambda}
...
### Solution to [Exercise -@sec-exercise-map-user-ids-to-names-with-series] {#sec-solution-map-user-ids-to-names-with-series}
