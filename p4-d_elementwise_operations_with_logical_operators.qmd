...
# Elementwise Operations with Logical Operators {#sec-series-elementwise-operations-logical}
...
The tilde (`~`) inverts all values in a Boolean series. Let's revisit @exr-inequality-operation-with-series-and-scalar to see how we can apply this operator. There, we used our series of activities.
...
::: {#exr-logical-operators}

Let's revisit @exr-inequality-operation-with-two-series and solve it using relational and logical operators (but without the `.map()` as it was done in the corresponding @sol-inequality-operation-with-two-series).
...
You can compare your solution to @sol-logical-operators.
:::
