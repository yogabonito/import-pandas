...
While Plotly also understands file extensions such as `.jpg` or `.png`, I strongly advise against doing using JPG and PNG. With such raster formats, the images will look pixelated when zoomed-in. On the other hand, vector formats, such as SVG or PDF, will always look crisp no matter how much we zoom in.
:::
